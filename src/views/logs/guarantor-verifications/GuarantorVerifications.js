...
import './GuarantorVerifications.css'

const GuarantorVerifications = () => {
  ...
  const fetchLogs = (page) => {
    ...
    const url = `${baseURL}/identity/api/v1/guarantor/get_verifications?page=${currentPage}`
    const headers = {
...
export default GuarantorVerifications
